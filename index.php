...
<html lang="en">
	<head>
		...
		<meta name="description" content="Omnifood is a premium foodd delivery service with the mission to bring affordable and health meals to as many people as possible.">
			...
			<nav>
				<div class="row">
					...
					<ul class="main-nav js--main-nav">
						...
						<li><a href="#cities">Out cities</a></li>
					...
					<div class="row">
						...
						<div class="col span-2-of-3">
							<select name="find-us" id="find-us">
								...
								<option value="ad">Advertiment</option>
